...
// 	logrus.Debugf("connecting to %s", c.config.URL)
...
// 			logrus.Debugf("received pong from server: %s", data)
...
// 			logrus.Debugf("received message type: %d, data length: %d", messageType, len(data))
