...
import (
	...
	apismeshv1alpha1 "github.com/karmada-io/karmada/pkg/apis/mesh/v1alpha1"
	versioned "github.com/karmada-io/karmada/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/karmada-io/karmada/pkg/generated/informers/externalversions/internalinterfaces"
	meshv1alpha1 "github.com/karmada-io/karmada/pkg/generated/listers/mesh/v1alpha1"
...
type MeshInformer interface {
	...
	Lister() meshv1alpha1.MeshLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MeshV1alpha1().Meshes().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MeshV1alpha1().Meshes().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MeshV1alpha1().Meshes().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MeshV1alpha1().Meshes().Watch(ctx, options)
			},
		},
		&apismeshv1alpha1.Mesh{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *meshInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apismeshv1alpha1.Mesh{}, f.defaultInformer)
}

func (f *meshInformer) Lister() meshv1alpha1.MeshLister {
	return meshv1alpha1.NewMeshLister(f.Informer().GetIndexer())
}
